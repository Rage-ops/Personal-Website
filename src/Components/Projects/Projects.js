const projects = [
  {
    id: 1,
    title: 'Engage-Board',
    tags: ["Ant-D UI library", "Node JS", "Express JS", "PostgreSQL/Sequelize ORM", "JWT", "Socket.io", "Azure Cognitive Services Content Moderator"],
  ...
  },
  {
    ...
    tags: ["Python3", "Minimax Algorithm"],
    info: `Implemented an AI which can't be defeated in Tic-Tac-Toe.
    Code Repo: https://github.com/harsha-sam/CS50-AI/tree/master/Search/tictactoe`,
