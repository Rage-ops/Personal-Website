  ...
  return (
    <footer>
      <div className="footer">
        <p className="data">© {new Date().getFullYear()} Harsha</p>
        <div className="icons">
          <a
            href="https://github.com/harsha-sam"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/harshavardhan-samudrala/"
            target="_blank"
            rel="noopener noreferrer"
          >
